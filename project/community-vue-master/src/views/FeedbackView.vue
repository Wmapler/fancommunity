<template>
  <div class="people">
      ...
      <el-form ref="form" :model="searchData" size="small" label-width="70px">
        <el-col :span="5">
          <el-form-item label="内容">
            <el-input v-model="searchData.note" placeholder="请输入意见姓名" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="5">
    ...
    <el-table v-loading="loading" :data="tableData" border style="width: 100%" :height="tableHeight">
      ...
      <el-table-column prop="reply" label="回复内容" align="center" width="140" show-overflow-tooltip> </el-table-column>
      ...
      <el-table-column fixed="right" label="操作" align="center" min-width="120">
        <template slot-scope="scope">
          <el-button @click="showFeedback(scope.row)" size="small">查看意见</el-button>
          <el-button type="primary" size="small" @click="replyFeedback(scope.row)" :disabled="scope.row.reply !== ''">回复意见</el-button>
    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" center width="50%">
      <el-form ref="dialogForm" :model="form" size="small" :disabled="disabled" class="my-dialog">
        ...
        <el-form-item label="回复内容" label-width="100px" prop="reply">
          <el-input type="textarea" v-model="form.reply" autocomplete="off" :disabled="show === 0"></el-input>
        </el-form-item>
