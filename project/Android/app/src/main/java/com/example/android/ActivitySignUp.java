    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!loginId.isEmpty()) {
                    AlertDialog alertDialog = new AlertDialog.Builder(ActivitySignUp.this)
                            .setTitle("验证码")
                            .setMessage("123456")
                            .create();
                    alertDialog.show();
                ...
                if (!loginId.isEmpty() && !psd.isEmpty() && !psd2.isEmpty() && !code1.isEmpty()) {
                    ...
                    NetUtil.NetListenerT listenerT=new NetUtil.NetListenerT() {
                        ...
                        public <T> void onResponse(JSONObject response) throws JSONException {
                            ...
                            ToastUtil.showMsg(ActivitySignUp.this,"注册成功");
                            //存储token
...
//                            System.out.println(token);
                    ...
                    NetUtil.requestSimple(ActivitySignUp.this,NetUtil.POST,url,params,listenerT);

                }else if (code1.isEmpty()) {
                    ToastUtil.showMsg(ActivitySignUp.this,"请输入验证码");
                }else if(psd.isEmpty() || psd2.isEmpty()){
                    ToastUtil.showMsg(ActivitySignUp.this,"请输入密码");
                }
