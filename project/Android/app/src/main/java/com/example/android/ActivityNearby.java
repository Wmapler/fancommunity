...
import com.example.android.adapter.MapAdapter;
import com.example.android.enity.LocationBean;
import com.example.android.enity.LocationEventBean;
...
public class ActivityNearby extends AppCompatActivity implements AMapLocationListener, LocationSource, PoiSearch.OnPoiSearchListener {
    ...
    private Context context = ActivityNearby.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvBaiduJuli = findViewById(R.id.tvBaiduJuli);
        seachCancel = findViewById(R.id.seach_cancel);
        seachSure = findViewById(R.id.seach_sure);
        seachName = findViewById(R.id.seach_name);
        rlTitle = findViewById(R.id.rl_title);
        //recyName = findViewById(R.id.recy_name);
        ...
        mMapAdapter = new MapAdapter(this,ActivityNearby.this);
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    ...
                    if (!TextUtils.isEmpty(input)) {
                        ...
                        try {
                            poiSearch = new PoiSearch(ActivityNearby.this, query);
                        } catch (AMapException e) {
                            e.printStackTrace();
                        }
                        poiSearch.setOnPoiSearchListener(ActivityNearby.this);
                        //poiSearch.setOnPoiSearchListener(ActivityNearby.this);
                        poiSearch.searchPOIAsyn();
                        //关闭软键盘
                        closeKeybord(ActivityNearby.this);
